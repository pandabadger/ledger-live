...
Type: (`"learn"` | `"pushNotifications"` | `"llmUsbFirmwareUpdate"` | `"ratings"` | `"counterValue"` | `"buyDeviceFromLive"` | `"ptxSmartRouting"` | `"ptxSmartRoutingMobile"` | `"walletConnectLiveApp"` | [string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String))
